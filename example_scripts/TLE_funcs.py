...
def TLE2pos(plen, ray_datenum, getnewTLE):
    ...
    if getnewTLE == 1:
        ...
        #print('acquired new TLEs')
    else:
        # 8/30 updated
        # DSX TLE
        l11 = '1 44344U 19036F   20243.10595853 -.00000043  00000-0  00000-0 0  9993'
        l21 = '2 44344  42.3123  45.5960 1972891 185.6398 171.8278  4.54372054 19628'
        # VPM TLE
        l12 = '1 45120U 19071K   20243.56610641  .00004103  00000-0  13219-3 0  9997'
        l22 = '2 45120  51.6437   4.5576 0011275 322.7752  37.2448 15.34436673 32398'
        lines1 = [l11, l12]
        lines2 = [l21, l22]
...
r, tvec = TLE2pos(100, ray_datenum, 0)
